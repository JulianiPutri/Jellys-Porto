    ...
    public function index()
    {
        $posts = [
            [
                ...
                'description' => 'Situs web yang ditampilkan adalah Ghibli Castle, yang menampilkan berbagai elemen dari dunia Studio Ghibli...',
            ],
            [
                'id' => 2,
                ...
                'description' => 'Situs web fanbase ini didedikasikan untuk NCT Dream, sebuah sub-unit dari grup K-Pop NCT...',
            ],
            [
                'id' => 3,
                ...
                'description' => 'Bitz Odyssey adalah sebuah game edukatif dibuat menggunakan construct3 berjenis petualangan platformer...',
            ],
        ];
